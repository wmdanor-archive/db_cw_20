...
class ControllerPSQL:
    ...
    def get_artists_listening_analysis_data(self, artists_filter, pagination_filter):
        ...
        filter_copy.albums.toggle = False
        filter_copy.playlists.toggle = False
        objects = self.model.get_artists(filter_copy, -6, pagination_filter)
        data = []
        for item in objects:
            data.append({
                'name': item['name'],
    ...
    def get_listening_history_analysis_data(self, history_filter):
        ...
        objects = self.model.get_compositions(filter_copy, 4, PaginationFilter())
        data = []
        for item in objects:
            data.append({
    ...
    def get_rating_analysis_data(self, rating_filter):
        ...
        filter_copy.user_rating_counter = False
        objects = self.model.get_compositions(filter_copy, 5, PaginationFilter())
        data = []
        for item in objects:
            data.append({
